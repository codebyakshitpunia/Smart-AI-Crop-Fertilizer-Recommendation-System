...
Input: User enters Nitrogen (N), Phosphorous (P), Potassium (K), pH, and Moisture levels.

API Call: The system fetches live weather data for the specified city.

Crop Prediction: A Random Forest model analyzes soil and weather to suggest the ideal crop.

Fertilizer Prediction: A secondary model recommends the specific fertilizer needed for that crop-soil combination.

Output: The UI displays the results instantly with a modern, responsive design.
